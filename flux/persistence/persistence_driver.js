...
PersistenceDriver.getLatestTrade = (fx) => {
    if (_a.trades.length > 0) {
        fx(res_1.GRes.succ(_a.trades[_a.trades.length - 1]));
    }
    else {
...
PersistenceDriver.toggleRapid = (value, fx) => {
    var _b;
    if (value === void 0) { value = !((_b = _a.db.value.rapid) !== null && _b !== void 0 ? _b : false); }
    if (fx === void 0) { fx = r => { }; }
    _a.db.next(Object.assign(Object.assign({}, _a.db.value), { rapid: value }));
    _a.registerChanges();
    fx(res_1.GRes.succ("SUCCESS"));
};
